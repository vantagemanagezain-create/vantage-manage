...
{/* MID BANNER - Advertise With Us */}
      <section className="mx-auto mb-6 w-full max-w-[380px] md:max-w-[450px] rounded-2xl bg-gradient-to-r from-orange-500 to-red-500 p-4 text-white shadow-lg text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2">
          {contactSettings.advertisement_phone && (
            <a
              href={buildTelHref(contactSettings.advertisement_phone)}
              className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-3 py-1.5 text-xs font-semibold text-orange-600 transition hover:bg-orange-50"
            >
              <Phone className="h-3.5 w-3.5" />
              Call
            </a>
          )}
          {contactSettings.advertisement_whatsapp && (
            <a
              href={`${buildWhatsAppHref(contactSettings.advertisement_whatsapp)}?text=${encodeURIComponent('Hello Vantage Manage, I am interested in advertising my business on your platform.')}`}
              target="_blank"
          ...
          {contactSettings.advertisement_email && (
            <a
              href={buildEmailHref(contactSettings.advertisement_email)}
              className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-3 py-1.5 text-xs font-semibold text-orange-600 transition hover:bg-orange-50"
            >
